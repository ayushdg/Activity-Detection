...
def load_data():
    data_dict = {}
    acc = pd.read_csv('data/csv/ashish/accelerometer-stand.csv', nrows=5000)
    gyro = pd.read_csv('data/csv/ashish/gyroscope-stand.csv', nrows=5000)
    mag = pd.read_csv('data/csv/ashish/magnetic-stand.csv', nrows=5000)
...
def run(input_array):
    ...
    try:
        ...
        model = joblib.load('testModel1.pkl')
